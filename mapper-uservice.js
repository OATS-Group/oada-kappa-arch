...
function mapper_uservice() {
	...
	let gps_client = new kafka.Client('vip4.ecn.purdue.edu:2181');
	...
	let fr_client = new kafka.Client('vip4.ecn.purdue.edu:2181');
	...
	function gps_matcher() {
		...
		fr_msg_buf.every(function(fr_msg, fr_index) {
			...
			*/
			console.log(colors.blue('map_uservice |', gps_msg_buf[closest_gps_index].lat,
									gps_msg_buf[closest_gps_index].lon, fr_msg.fuelrate));
...
module.exports = mapper_uservice;
